...
BLECharacteristic XaxisChar(BLEUUID(),BLECharacteristic::PROPERTY_NOTIFY);
BLECharacteristic YaxisChar(BLEUUID(),BLECharacteristic::PROPERTY_NOTIFY);
BLECharacteristic ZaxisChar(BLEUUID(),BLECharacteristic::PROPERTY_NOTIFY);
